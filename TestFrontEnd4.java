...
//                 multiple JUnit Tests (This is Test4) 
...
public class TestFrontEnd4 {
	/**
	 * Test that Search by Name Mode displays proper greeting
	 */
	@Test 
	public void testNameMode() {
		...
		try { 
	        ...
	        Frontend.searchByNameMode(backend);
